...
from aura.services.ai_service import generate_mental_response, generate_study_response, extract_sentiment, analyze_study_material, predict_emotion_and_stress
from aura.services.stress_service import calculate_dynamic_stress
from aura.services.risk_service import predict_risk_level
from aura.services.memory_service import update_emotion_memory, get_emotion_memory
from aura.utils.auth_helpers import demo_restricted, demo_chat_limited, login_required
from aura.utils.helpers import safe_error
from aura.utils.rate_limit import apply_rate_limit, Limits
from aura.utils.crisis_detection import detect_crisis
from aura.utils.alerts import send_crisis_alert
...
def api_chat_mental():
    ...
    try:
        ...
        from aura.utils.schemas import ChatMessageRequest, ValidationError
        try:
