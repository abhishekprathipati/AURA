...
import io
import csv
from aura.utils.auth_helpers import login_required, demo_restricted, role_required, csrf_protected
...
def add_student():
    ...
    try:
        ...
        from aura.utils.schemas import StudentAddRequest, ValidationError as SchemaError
        try:
        ...
        from aura.services.proctor_service import register_new_student
        student_data = {
            'name': name,
...
def add_proctor():
    ...
    """
    try:
        from aura.utils.schemas import ProctorAddRequest, ValidationError as SchemaError
        try:
        ...
        from aura.utils.auth_helpers import hash_password, generate_temp_password
