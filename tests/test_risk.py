...
class TestPredictRiskLevel:
    ...
    def test_low_score_low_risk(self, mock_db):
        from aura.services.risk_service import predict_risk_level, LOW_RISK
        result = predict_risk_level(20, "I had a good day today")
        assert result == LOW_RISK

    def test_high_score_elevated_risk(self, mock_db):
        from aura.services.risk_service import predict_risk_level, HIGH_RISK, CRITICAL_RISK
    ...
    def test_crisis_keywords_trigger_critical(self, mock_db):
        from aura.services.risk_service import predict_risk_level, CRITICAL_RISK
    ...
    def test_moderate_score_moderate_risk(self, mock_db):
        from aura.services.risk_service import predict_risk_level, MODERATE_RISK, LOW_RISK
...
class TestCrisisKeywords:
    ...
    def test_english_crisis_detected(self):
        from aura.utils.crisis_keywords import contains_crisis_language
