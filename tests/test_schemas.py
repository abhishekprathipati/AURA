...
class TestUserSchema:
    ...
    def test_valid_user(self):
        from aura.models.schemas import UserSchema
        user = UserSchema(
...
class TestMoodSchema:
    ...
    def test_valid_mood(self):
        from aura.models.schemas import MoodSchema
        mood = MoodSchema(
...
class TestChatSchema:
    ...
    def test_valid_chat_message(self):
        from aura.models.schemas import ChatSchema
        chat = ChatSchema(
            user_email="test@aura.edu",
            role="user",
...
class TestStressSchema:
    ...
    def test_valid_stress(self):
        from aura.models.schemas import StressSchema
